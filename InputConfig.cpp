...
void InputConfig::HomeInputLogic(int& x, int& y, int width, int height, int bottomExitXCoordinateOne, int bottomExitXCoordinateTwo)
{
    switch (userInput)
    {
    case LEFT:
...
void InputConfig::NSExitInputLogic(int x, int y, int width, int height, int bottomExitXCoordinateOne, int bottomExitXCoordinateTwo, int topExitXCoordinateOne, int topExitXCoordinateTwo)
{
    switch (userInput)
    {
    case LEFT:
    ...
    case UP:
        if (y > 0 || (x == topExitXCoordinateOne && y == (height - 1)) || (x == topExitXCoordinateTwo && y == (height - 1)))
        {
            y--;
            break;
        }
